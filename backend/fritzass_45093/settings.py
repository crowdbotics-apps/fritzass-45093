"""
Django settings for fritzass_45093 project.
...
ROOT_URLCONF = 'fritzass_45093.urls'
...
WSGI_APPLICATION = 'fritzass_45093.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fritzass_45093 API",
    "DESCRIPTION": "API documentation for fritzass_45093 App",
    "VERSION": "v1",
}
